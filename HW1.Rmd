...
We see somewhat of a bimodial distribution with a mean at around 32-33
...
```
```{r}
 ggplot(mpg, aes(x=hwy,fill=cyl)) + 
  geom_boxplot()
```
```{r}
 #ggplot(mpg, aes(x=cyl, y= hwy, fill=cyl)) + 
  #geom_boxplot()
boxplot(hwy ~ cyl, data = mpg,col = c("blue", "yellow", "green","blue"))
``` 
